  ...
  return (
    <div style={{
      ...
      <h2 style={{
        ...
        Visualização - Template {template === 'modern' ? 'Moderno' : template === 'classic' ? 'Clássico' : template === 'creative' ? 'Criativo' : template === 'minimal' ? 'Minimalista' : template === 'professional' ? 'Profissional' : 'Elegante'}
      </h2>
      ...
      <div style={{
        ...
        {/* Header */}
        <div style={{
          background: template === 'modern' ? `linear-gradient(135deg, ${templateStyles.accentColor}, #8b5cf6)` : templateStyles.headerBg,
          color: 'white',
          padding: '24px',
          borderRadius: '8px',
          textAlign: 'center',
                ...
                <span
                  ...
                  style={{
                    ...
                    background: template === 'creative' 
                      ...
                      ? '#ecf0f1'
                      : '#f1f5f9',
                    color: template === 'creative' ? 'white' : theme.text === '#f1f5f9' ? '#e2e8f0' : '#2c3e50',
                    borderRadius: template === 'creative' ? '20px' : '16px',
                    fontSize: '13px',
                    fontWeight: '500',
                    boxShadow: template === 'creative' ? '0 2px 8px rgba(102, 126, 234, 0.3)' : 'none'
                  }}
                >
                ...
                <div key={exp.id} style={{
                  ...
                  <div style={{
                    ...
                    <span style={{
                      ...
                      background: template === 'creative' ? 'rgba(102, 126, 234, 0.1)' : '#f8f9fa',
                      padding: '4px 8px',
                      borderRadius: '4px'
                    }}>
                      {exp.startDate ? new Date(exp.startDate).getFullYear() : 'N/A'} - {' '}
                      {exp.isCurrentJob ? 'Atual' : (exp.endDate ? new Date(exp.endDate).getFullYear() : 'N/A')}
                    </span>
                  </div>
                  {exp.description && (
                    <p style={{
        ...
        {/* Empty State */}
        {!personalData.name && skills.length === 0 && experiences.length === 0 && (
          <div style={{
            textAlign: 'center',
            padding: '64px 32px',
