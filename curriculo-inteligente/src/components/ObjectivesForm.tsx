    ...
    <div style={{
      ...
      <div>
        ...
        <textarea
          ...
          style={{
            ...
            fontSize: '14px',
            outline: 'none',
            background: objective ? (theme.inputBg === '#334155' ? '#64748b' : theme.inputBg) : theme.inputBg,
            color: theme.text,
            resize: 'none',
            transition: 'all 0.3s ease'
          }}
      ...
      {!objective && (
        <div style={{
          ...
          <p style={{ fontSize: '14px', marginBottom: '4px' }}>Defina seus objetivos de carreira</p>
          <p style={{ fontSize: '12px', color: theme.text, opacity: 0.6 }}>Quais são suas metas profissionais?</p>
        </div>
      )}
    </div>
  );
